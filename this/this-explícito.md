...
¿Y para qué podemos usar esto realmente? Tiene su lógica si activamos _noImplicitThis en el tsconfig.json. Con esto el compilador _nos avisa de los this que no tienen un valor específico, sino que suelen ser Any.
